...
func (h *JobHandler) Seed() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		s1 := courses.Subject{Title: "Software Fundamentals", Slug: "software-fundamentals", ImgURL: "software-fundamentals.svg"}
		s2 := courses.Subject{Title: "Python", Slug: "python", ImgURL: "python.svg"}
		s3 := courses.Subject{Title: "Vue", Slug: "vue", ImgURL: "vue.svg"}
		...
		c1 := courses.Course{
			...
			ImgURL:      "software-fundamentals.svg",
		}
		c2 := courses.Course{
			SubjectID:   ss[0].ID,
			Title:       "Algorithms",
